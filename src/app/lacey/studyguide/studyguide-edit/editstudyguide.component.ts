...
@Component({
    selector: 'app-edit-studyguide',
    templateUrl: './editstudyguide.component.html'
})

// tslint:disable:max-line-length
export class EditStudyGuideComponent {
    ...
    @ViewChild('editStudyGuideForm') currentForm: NgForm;
